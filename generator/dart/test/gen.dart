...
Map<int, Rat> dictInt_RatFromJson(dynamic json) {
  if (json == null) {
    return {};
  }
...
Map<String, dynamic> dictInt_RatToJson(Map<int, Rat> item) {
...
structWithExternalRef structWithExternalRefFromJson(dynamic json_) {
  final json = (json_ as JSON);
  return structWithExternalRef(contextFromJson(json['Field1']),
      cancelFuncFromJson(json['Field2']), dictInt_RatFromJson(json['Field3']));
}

JSON structWithExternalRefToJson(structWithExternalRef item) {
  return {
    "Field1": contextToJson(item.field1),
    "Field2": cancelFuncToJson(item.field2),
    "Field3": dictInt_RatToJson(item.field3)
  };
}
